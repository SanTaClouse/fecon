...
const SEED: FilaCatalogo[] = [
  ...
  c("casa_desde_0", "Revoques", "Revoque fino interior", "m²", 12500),
  c("casa_desde_0", "Revoques", "Revoque grueso", "m²", 35000),
  c("casa_desde_0", "Revoques", "Revoque exterior impermeable", "m²", 35000),
